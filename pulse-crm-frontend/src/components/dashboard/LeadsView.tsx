...
export default function LeadsView() {
  ...
  return (
    <div className="grid grid-cols-12 gap-6 items-start">
      ...
      <div className={`col-span-12 ${selectedLeadId !== null ? 'lg:col-span-8' : 'lg:col-span-12'} transition-all duration-300 space-y-5`}>
            ...
            <div className="flex items-start justify-between border-b border-brand-border-purple/15 pb-3">
              ...
              <div className="flex items-center space-x-2">
                ...
                <button 
                  ...
                  className="p-1 hover:bg-slate-100 rounded-lg text-slate-450 hover:text-brand-text transition-colors cursor-pointer"
                  title="Close Details"
                >
                  <X className="h-4 w-4" />
                </button>
