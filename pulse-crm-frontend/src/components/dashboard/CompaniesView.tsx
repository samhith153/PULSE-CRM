...
export default function CompaniesView() {
  ...
  const active = companies.find(c => c.id === selectedId);
  ...
  return (
    <div className="grid grid-cols-12 gap-6 items-start">
      {/* Companies List */}
      <div className={`col-span-12 ${selectedId !== null ? 'lg:col-span-8' : 'lg:col-span-12'} transition-all duration-300 space-y-5`}>
      ...
      {/* Details Side Panel */}
      {active && (
      <div className="col-span-12 lg:col-span-4 space-y-5 transition-all duration-300">
        <div className="bg-white border border-brand-border-purple/20 rounded-xl p-5 shadow-sm/5 sticky top-20">
          ...
          <button onClick={() => setSelectedId(null)} className="text-slate-400 hover:text-brand-text p-1 cursor-pointer" title="Close panel"><X className="h-4 w-4" /></button>
          </div>
