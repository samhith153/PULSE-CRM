"""
CRM Note Model
Represents an internal note linked to any CRM entity.
"""
...
class CrmNote(Base, TenantMixin):
    """An internal CRM note attached to any entity."""
    ...
    def __repr__(self) -> str:
        return f"<CrmNote id={self.id} title={self.title!r}>"
