...
class WorkflowTaskRepository(BaseRepository[WorkflowTask]):
    ...
    async def get_active_for_lead(
        ...
        """Return the current pending/in-progress workflow task."""
    ...
    async def get_by_id_for_organization(
        ...
        """Get a workflow task while enforcing tenant isolation."""
        result = await self.db.execute(
            select(WorkflowTask)
            .where(
    ...
    async def list_for_lead(
        ...
        """Return workflow history for a lead."""
        result = await self.db.execute(
            select(WorkflowTask)
            .where(
                WorkflowTask.organization_id == organization_id,
    ...
    async def create_task(
        ...
        *,
        ...
        """Create a workflow task from an AI recommendation."""
    ...
    async def supersede(
        ...
        """Mark the previous workflow task as superseded."""
    ...
    async def expire(
        ...
        """Mark an overdue workflow task as expired."""
    ...
    async def get_expired_tasks(
        ...
        """Find pending/in-progress tasks whose deadline has passed."""
        ...
        result = await self.db.execute(
            ...
            .order_by(WorkflowTask.due_at.asc())
            .limit(limit)
        )
