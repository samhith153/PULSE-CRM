...
def _summarise_text(text: str, max_sentences: int = 3) -> SummariseResponse:
    ...
    if not cleaned:
        return SummariseResponse(
            ...
            action_items=[],
            category="general",
            draft_reply="No reply suggested.",
            follow_up_suggestion="No follow-up suggested.",
            follow_up_timing="no_followup"
        )
