    ...
    <header className="sticky top-0 z-50">
      ...
      >
        ...
        >
          ...
          <div className="flex shrink-0 items-center gap-2">
            ...
            <Link
              to="/login"
              className="hidden rounded-full px-3.5 py-2 text-sm font-medium text-ink transition-colors hover:text-link sm:inline-flex"
            >
              Sign in
            </Link>
            <Link
      ...
      {mobileOpen && (
        <div className="menu-in relative z-50 border-b border-border bg-background px-6 py-4 lg:hidden">
          ...
          <Link
            to="/login"
            className="mt-2 flex w-full items-center justify-center rounded-full border border-border py-3 text-sm font-medium text-ink transition-colors hover:bg-secondary"
          >
            Sign in
          </Link>
        </div>
