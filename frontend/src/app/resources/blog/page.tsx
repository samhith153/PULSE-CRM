      ...
      <section style={{ padding: '60px 48px', background: '#fff' }}>
        <div style={{ maxWidth: 1280, margin: '0 auto' }}>
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
            whileHover={{ y: -4 }}
            style={{ display: 'grid', gridTemplateColumns: '1.5fr 0.5fr', gap: 40, background: 'linear-gradient(135deg, #EFF6FF 0%, #fff 100%)', borderRadius: 24, overflow: 'hidden', border: '1px solid #e2e8f0', boxShadow: '0 8px 24px rgba(37,99,235,0.10)', cursor: 'pointer' }}>
