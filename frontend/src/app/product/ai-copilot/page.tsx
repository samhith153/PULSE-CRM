  ...
  <div style={{ padding: '20px', background: '#f8fafc' }}>
    <div style={{ background: '#EFF6FF', borderRadius: 12, padding: '20px', border: '1px solid #DBEAFE' }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 16 }}>
        ...
        <div>
          <div style={{ fontSize: 13, fontWeight: 700, color: '#1E3A8A' }}>AI Scoring Engine</div>
          <div style={{ fontSize: 11, color: '#2563EB' }}>Rule-based · Transparent · 0–100</div>
        </div>
      </div>
      {/* Score breakdown */}
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10, marginBottom: 12 }}>
        <div style={{ background: '#fff', borderRadius: 10, padding: '12px', border: '1px solid #DBEAFE' }}>
          ...
          <div style={{ fontSize: 24, fontWeight: 900, color: '#2563EB' }}>78</div>
      ...
      <div style={{ background: '#fff', borderRadius: 10, padding: '12px', border: '1px solid #DBEAFE' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <div>
            <div style={{ fontSize: 10, fontWeight: 700, color: '#2563EB' }}>OVERALL SCORE · HIGH TIER</div>
  ...
  return (
    <PageContainer>
      <HeroWithScreenshot
        ...
        badgeIcon={Sparkles}
        title={<>Transparent scoring.<br /><span style={{ color: '#2563EB' }}>No black box.</span></>}
      ...
      <section style={{ padding: '80px 48px', background: '#fff' }}>
        <div style={{ maxWidth: 1080, margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 48, alignItems: 'center' }}>
          ...
          <motion.div
            ...
            <div style={{ fontSize: 13, fontWeight: 700, color: '#2563EB', marginBottom: 16 }}>Priority Tiers</div>
            {[
