...
const featureMap: Record<string, { icon: React.ComponentType<any>; title: string; desc: string; href: string; color: string }[]> = {
  dashboard: [
    ...
    { icon: Activity, title: 'Activity Feed', desc: 'Live log of calls, emails, and notes across your team.', href: '/features/dashboard', color: '#2563EB' },
  ...
  leads: [
    { icon: Target, title: 'Lead Capture', desc: 'Create leads via API, form, or CSV import automatically.', href: '/features/contacts', color: '#2563EB' },
    ...
    { icon: FileText, title: 'Lead Reports', desc: 'Breakdown by status, source, owner, and time period.', href: '/features/analytics', color: '#2563EB' },
  ...
  contacts: [
    { icon: Users, title: 'Contact Profiles', desc: 'Rich profiles: name, email, phone, job title, department, LinkedIn.', href: '/features/contacts', color: '#2563EB' },
    ...
    { icon: Sparkles, title: 'Smart Deduplication', desc: 'Unique email constraints and server-side duplicate detection.', href: '/features/contacts', color: '#2563EB' },
  ...
  companies: [
    { icon: Building2, title: 'Company Profiles', desc: 'Name, domain, industry, employee count, website, and social links.', href: '/features/contacts', color: '#2563EB' },
    ...
    { icon: BarChart2, title: 'Account Analytics', desc: 'Revenue, deal count, and engagement metrics per account.', href: '/features/analytics', color: '#2563EB' },
  ...
  pipeline: [
    { icon: TrendingUp, title: 'Visual Pipeline', desc: 'FSM-based kanban with stages: New → Discovery → Proposal → Negotiation → Closed.', href: '/features/pipeline', color: '#2563EB' },
    ...
    { icon: Sparkles, title: 'AI Forecasting', desc: 'GPT-4o predicts end-of-quarter revenue from pipeline state.', href: '/features/ai-copilot', color: '#2563EB' },
  ...
  deals: [
    { icon: Briefcase, title: 'Deal Management', desc: 'Track every opportunity with value (₹), dates, and owner.', href: '/features/pipeline', color: '#2563EB' },
    ...
    { icon: FileText, title: 'Deal Reports', desc: 'Win/loss analysis, cycle time, and revenue attribution.', href: '/features/analytics', color: '#2563EB' },
  ...
  activities: [
    { icon: Activity, title: 'Activity Timeline', desc: 'All calls, emails, notes, and meetings in one chronological feed.', href: '/features/dashboard', color: '#2563EB' },
    ...
    { icon: Workflow, title: 'Auto-Log Activities', desc: 'Email sync auto-creates email activity records per contact.', href: '/features/email-sync', color: '#2563EB' },
  ...
  'ai-copilot': [
    { icon: Sparkles, title: 'Lead Scoring', desc: 'Every lead scored 0–100 using GPT-4o context analysis.', href: '/features/ai-copilot', color: '#2563EB' },
    ...
    { icon: Activity, title: 'Anomaly Detection', desc: 'Flag stalled deals, ghosted contacts, and activity drops.', href: '/features/ai-copilot', color: '#2563EB' },
  ...
  'email-sync': [
    { icon: Mail, title: 'Gmail OAuth', desc: 'One-click Gmail connect with per-user inbox isolation.', href: '/features/email-sync', color: '#2563EB' },
    ...
    { icon: FileText, title: 'Email Templates', desc: 'Save and reuse email templates across your sales team.', href: '/features/email-sync', color: '#2563EB' },
  ...
  analytics: [
    { icon: BarChart2, title: 'Revenue Analytics', desc: 'Revenue by period, rep, source, and deal type.', href: '/features/analytics', color: '#2563EB' },
    ...
    { icon: Activity, title: 'Activity Heatmap', desc: 'Visualise when and how often reps are active.', href: '/features/analytics', color: '#2563EB' },
  ...
  reports: [
    { icon: FileText, title: 'Custom Reports', desc: 'Build and save custom reports with flexible filters.', href: '/features/analytics', color: '#2563EB' },
    ...
    { icon: Users, title: 'Team Reports', desc: 'Manager-level team performance breakdowns.', href: '/features/analytics', color: '#2563EB' },
  ...
  automation: [
    { icon: Workflow, title: 'Workflow Builder', desc: 'Build no-code automation workflows triggered by CRM events.', href: '/features/contacts', color: '#2563EB' },
    ...
    { icon: Activity, title: 'Activity Reminders', desc: 'Auto-create follow-up tasks based on contact inactivity.', href: '/features/dashboard', color: '#2563EB' },
  ...
  api: [
    { icon: Code, title: 'REST API', desc: '40+ endpoints. Full CRUD for leads, contacts, deals, companies.', href: '/features/dashboard', color: '#2563EB' },
    ...
    { icon: Workflow, title: 'Webhooks', desc: 'Outgoing webhooks on deal stage change, lead creation, and more.', href: '/features/dashboard', color: '#2563EB' },
  ...
  settings: [
    { icon: Settings, title: 'Organization Settings', desc: 'Manage your workspace name, slug, timezone, and branding.', href: '/features/dashboard', color: '#2563EB' },
    ...
    { icon: Sparkles, title: 'AI Settings', desc: 'GPT-4o API key, scoring thresholds, and model preferences.', href: '/features/ai-copilot', color: '#2563EB' },
