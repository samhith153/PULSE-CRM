...
const contentMap: Record<string, { icon: React.ElementType; title: string; desc: string; href: string; color: string }[]> = {
  industry: [
    ...
    { icon: Landmark, title: 'Finance', desc: 'Compliance-ready CRM with JWT auth, RBAC, and encrypted data at rest.', href: '/features/contacts', color: '#2563EB' },
  ...
  team: [
    { icon: Users, title: 'Sales Teams', desc: 'FSM pipelines, leaderboards, AI scoring, and Gmail sync built for closers.', href: '/features/pipeline', color: '#2563EB' },
    ...
    { icon: Settings, title: 'IT & Admins', desc: '33-permission RBAC system, SSO, audit logs, and API access control.', href: '/features/dashboard', color: '#2563EB' },
  ...
  size: [
    { icon: Zap, title: 'Solo & Freelance', desc: '1-person CRM. Free trial, no credit card. Up and running in 2 minutes.', href: '/features/dashboard', color: '#2563EB' },
  ...
  department: [
    { icon: Target, title: 'Sales', desc: 'Leads, pipeline, deals, and AI-assisted closing workflows.', href: '/features/pipeline', color: '#2563EB' },
    ...
    { icon: Landmark, title: 'Finance', desc: 'Deal revenue tracking, close date forecasting, and pipeline value reports.', href: '/features/analytics', color: '#2563EB' },
  ...
  usecase: [
    { icon: Target, title: 'Lead Generation', desc: 'Capture, score, and route inbound leads from API, forms, or CSV.', href: '/features/contacts', color: '#2563EB' },
    ...
    { icon: Heart, title: 'Customer Retention', desc: 'Track renewal dates, engagement scores, and churn signals.', href: '/features/analytics', color: '#2563EB' },
  ...
  migration: [
    { icon: Settings, title: 'Migrate from Salesforce', desc: 'Import contacts, deals, and history via our REST API or CSV migration tool.', href: '/features/contacts', color: '#2563EB' },
    ...
    { icon: Target, title: 'Data Validation', desc: 'Duplicate email checks, format validation, and conflict resolution.', href: '/features/contacts', color: '#2563EB' },
