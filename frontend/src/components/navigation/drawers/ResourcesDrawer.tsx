...
const contentMap: Record<string, { icon: React.ElementType; title: string; desc: string; href: string; color: string }[]> = {
  docs: [
    ...
    { icon: Sparkles, title: 'AI Copilot Guide', desc: 'Configure GPT-4o integration, lead scoring thresholds, and model settings.', href: '/features/ai-copilot', color: '#2563EB' },
  ...
  blog: [
    { icon: FileText, title: 'Building a CRM with FastAPI', desc: 'How we built 40+ REST endpoints with Clean Architecture and DDD.', href: '/features/dashboard', color: '#2563EB' },
    ...
    { icon: Code, title: 'JWT Auth in Python', desc: 'Access tokens, refresh tokens, and secure password reset flow.', href: '/features/dashboard', color: '#2563EB' },
  ...
  community: [
    { icon: Users, title: 'Developer Forum', desc: 'Ask questions, share integrations, and get help from the Pulse community.', href: '/features/dashboard', color: '#2563EB' },
    ...
    { icon: Bell, title: 'Community Blog', desc: 'User-written guides, tips, and workflows for the Pulse CRM ecosystem.', href: '/features/dashboard', color: '#2563EB' },
  ...
  support: [
    { icon: HeadphonesIcon, title: 'Live Chat Support', desc: '24/7 live chat with real humans who know the codebase.', href: '/features/dashboard', color: '#2563EB' },
    ...
    { icon: BookOpen, title: 'Onboarding Sessions', desc: 'Scheduled 1:1 onboarding calls for Growth and Enterprise customers.', href: '/features/dashboard', color: '#2563EB' },
  ...
  api: [
    { icon: Code, title: 'REST API Overview', desc: '40+ endpoints with OpenAPI spec at /openapi.json and Swagger at /docs.', href: '/features/dashboard', color: '#2563EB' },
    ...
    { icon: FileText, title: 'Deals & Pipeline API', desc: 'GET/POST /api/v1/deals and pipeline stage management endpoints.', href: '/features/pipeline', color: '#2563EB' },
  ...
  tutorials: [
    { icon: Play, title: 'Setup in 5 Minutes', desc: 'Docker → alembic upgrade head → seed → uvicorn. Full walkthrough.', href: '/features/dashboard', color: '#2563EB' },
    ...
    { icon: FileText, title: 'Custom Reports', desc: 'Build and export custom analytics reports using the reports API.', href: '/features/analytics', color: '#2563EB' },
  ...
  videos: [
    { icon: Video, title: 'Product Walkthrough', desc: 'Full 15-minute video tour of every feature in Pulse CRM.', href: '/features/dashboard', color: '#2563EB' },
    ...
    { icon: BarChart2, title: 'Analytics Overview', desc: 'Configure revenue reports, leaderboards, and export to CSV.', href: '/features/analytics', color: '#2563EB' },
  ...
  release: [
    { icon: Bell, title: 'v1.0.0 — Launch Release', desc: 'JWT auth, RBAC (33 permissions), 40+ REST endpoints, Gmail sync, AI scoring.', href: '/features/dashboard', color: '#2563EB' },
    ...
    { icon: Download, title: 'Database Migrations', desc: 'Alembic migrations for all 11 tables with FK constraints and indexes.', href: '/features/dashboard', color: '#2563EB' },
