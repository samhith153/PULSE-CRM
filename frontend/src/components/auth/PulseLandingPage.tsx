        ...
        <div style={{ position: 'fixed', inset: 0, zIndex: 2000, display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'rgba(15,23,42,0.65)', backdropFilter: 'blur(6px)' }}
          ...
          <div onClick={e => e.stopPropagation()} style={{ background: C.white, borderRadius: 20, width: '100%', maxWidth: 380, padding: '24px 28px 20px', boxShadow: '0 32px 80px rgba(0,0,0,0.22)', position: 'relative' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 4 }}>
              <div style={{ height: 30, width: 30, borderRadius: 8, background: C.violet, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 6, marginBottom: 16 }}>
              {(['admin', 'manager', 'representative'] as Role[]).map(r => (
                <button key={r} onClick={() => setSelectedRole(r)}
                  style={{ padding: '7px 4px', borderRadius: 8, border: `2px solid ${selectedRole === r ? C.violet : C.border}`, background: selectedRole === r ? C.violetLighter : C.white, cursor: 'pointer', fontSize: 10, fontWeight: 700, color: selectedRole === r ? C.violet : C.textGray, textTransform: 'capitalize', transition: 'all 0.15s', fontFamily: 'inherit' }}>
            ...
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
              <div>
                ...
                <div style={{ position: 'relative' }}>
                  <Mail size={13} color={C.textMuted} style={{ position: 'absolute', left: 12, top: '50%', transform: 'translateY(-50%)', pointerEvents: 'none' }} />
              ...
              <div>
                ...
                <div style={{ position: 'relative' }}>
                  <Lock size={13} color={C.textMuted} style={{ position: 'absolute', left: 12, top: '50%', transform: 'translateY(-50%)', pointerEvents: 'none' }} />
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, margin: '14px 0' }}>
              ...
              <span style={{ fontSize: 11, color: C.textMuted, fontWeight: 500 }}>or continue with</span>
              <div style={{ flex: 1, height: 1, background: C.border }} />
            </div>
            <button onClick={() => addToast('Google sign-in is currently unavailable.', 'error')}
              style={{ width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, padding: '10px', background: C.white, border: `1.5px solid ${C.border}`, borderRadius: 10, fontSize: 13, fontWeight: 700, color: C.black, cursor: 'pointer', fontFamily: 'inherit', boxShadow: '0 2px 8px rgba(0,0,0,0.06)' }}>
