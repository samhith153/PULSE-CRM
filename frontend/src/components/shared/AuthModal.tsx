      ...
      <div onClick={e => e.stopPropagation()}
        ...
        {googleClientId ? (
          <div style={{ display: 'flex', justifyContent: 'center', minHeight: 40 }}>
            <div id="google-signin-btn-container" style={{ width: '100%', maxWidth: 316 }} />
          </div>
        ) : (
          <>
            ...
            <p style={{ textAlign: 'center', fontSize: 11, color: '#94a3b8', margin: '8px 0 0' }}>Google Sign-In is not configured on the server.</p>
          </>
        )}
