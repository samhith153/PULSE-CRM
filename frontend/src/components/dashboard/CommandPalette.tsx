...
export default function CommandPalette({ isOpen, onClose, setActiveTab, onNewReportClick }: CommandPaletteProps) {
  ...
  const allCommands = useMemo<CommandItem[]>(() => {
    return [
      ...
      { id: 'create-task', title: 'Create Task', description: 'Log a new task in activities', category: 'Create Quick Actions', icon: Plus, action: () => { transitionAndEmit('activities', 'pulse-open-create-task-modal'); onClose(); }, shortcut: 'N T' },
