...
import { Loader2, TrendingUp, TrendingDown, Users, Target, BarChart3, Activity, Zap, AlertTriangle, ChevronDown } from 'lucide-react';
import {
    ...
    <div className="w-full space-y-6">
      ...
      <div className="flex flex-wrap items-end gap-3">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">Manager performance overview backed by live data.</p>
        </div>
