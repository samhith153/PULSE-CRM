...
start "PULSE-CRM Backend" cmd /k "cd /d C:\Users\Admin\Documents\GitHub\PULSE-CRM\backend && .pulsevenv\Scripts\python.exe main.py"
timeout /t 3 /nobreak >nul

:: Start frontend
echo [3/4] Starting frontend on port 3000...
start "PULSE-CRM Frontend" cmd /k "cd /d C:\Users\Admin\Documents\GitHub\PULSE-CRM\frontend && npm run dev"
