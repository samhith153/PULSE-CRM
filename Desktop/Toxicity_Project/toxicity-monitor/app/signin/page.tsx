    ...
    <div style={{ minHeight: "calc(100vh - 64px)", display: "flex", alignItems: "center", justifyContent: "center", padding: "2rem", background: "var(--bg-primary)" }}>
      <div style={{ width: "100%", maxWidth: 420 }}>
        <div style={{ textAlign: "center", marginBottom: "2rem" }}>
          <h1 style={{ fontSize: "1.75rem", fontWeight: 700, letterSpacing: "-0.5px", marginBottom: "0.5rem" }}>Welcome back</h1>
        ...
        <div style={{ background: "var(--bg-secondary)", border: "1px solid var(--border-subtle)", borderRadius: 16, padding: "2.5rem" }}>
          ...
          <form onSubmit={handleEmailSignIn} style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
            <div>
              ...
              <input type="email" placeholder="you@example.com" value={email} onChange={e => setEmail(e.target.value)} required className="input-minimal" />
            </div>
            <div>
              ...
              <input type="password" placeholder="••••••••" value={password} onChange={e => setPassword(e.target.value)} required className="input-minimal" />
            </div>
            <button type="submit" className="btn-core" style={{ width: "100%", marginTop: "0.5rem" }} disabled={!!loading}>
          ...
          <p style={{ textAlign: "center", marginTop: "1.5rem", fontSize: "0.875rem", color: "var(--text-muted)" }}>
            ...
            <Link href="/register" style={{ color: "var(--text-primary)", fontWeight: 600, textDecoration: "none" }}>Register →</Link>
          </p>
        </div>
      </div>
    </div>
